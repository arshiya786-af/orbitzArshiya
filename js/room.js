var checkData = [
    {   img :"https://images.trvl-media.com/hotels/10000000/9790000/9784600/9784580/b5248663.jpg?impolicy=fcrop&w=1200&h=800&p=1&q=medium",
        ...
        extra : "Extras",
        inter : "High-Speed internet + Resort credit",
        wifi : "Wifi",
        wifi_bf : "WiFi + Breakfast buffet",
        interCharge :0,
        bfCharge:23,
        wifiCharge :9,
        room_price: 85,
    ...
    {   img :"https://images.trvl-media.com/hotels/10000000/9790000/9784600/9784580/6273e2d7.jpg?impolicy=fcrop&w=1200&h=800&p=1&q=medium",
        roomName :"Deluxe Room, 2 Double Beds", 
        sqFt:"409 sq ft",
        sleep: "Sleeps 3",
        bed: "2 Double Beds",
        parking : "Free self parking",  
    ...
    {   img :"https://images.trvl-media.com/hotels/10000000/9790000/9784600/9784580/301c2d2e.jpg?impolicy=fcrop&w=1200&h=800&p=1&q=medium",
        roomName :"Deluxe Room, 2 Double Beds, Pool View", 
        sqFt:"409 sq ft",
        sleep: "Sleeps 3",
        bed: "2 Double Beds",
        parking : "Free self parking",  
    ...
    {   img :"https://images.trvl-media.com/hotels/10000000/9790000/9784600/9784580/f8f8b603.jpg?impolicy=fcrop&w=1200&h=800&p=1&q=medium",
        roomName :"Deluxe Room, 1 King Bed, Pool View", 
        sqFt:"413 sq ft",
        sleep: "Sleeps 3",
        bed: "1 King Beds",
        parking : "Free self parking",  
    ...
    {   img :"https://images.trvl-media.com/hotels/10000000/9790000/9784600/9784580/4b812441.jpg?impolicy=fcrop&w=1200&h=800&p=1&q=medium",
        roomName :"Deluxe Room, 2 Double Beds, Balcony", 
        sqFt:"409 sq ft",
        sleep: "Sleeps 3",
        bed: "2 Double Beds",
        parking : "Free self parking",  
    ...
    {   img :"https://images.trvl-media.com/hotels/10000000/9790000/9784600/9784580/93ace1d8.jpg?impolicy=fcrop&w=1200&h=800&p=1&q=medium",
        roomName :"Deluxe Room, 1 King Bed, Balcony", 
        sqFt:"409 sq ft",
        sleep: "Sleeps 3",
        bed: "1 King Beds",
        parking : "Free self parking",  
    ...
    {   img :"https://images.trvl-media.com/hotels/10000000/9790000/9784600/9784580/a1b56779.jpg?impolicy=fcrop&w=1200&h=800&p=1&q=medium",
        roomName :"Room, 2 Double Beds, Non Smoking", 
        sqFt:"409 sq ft",
        sleep: "Sleeps 3",
        bed: "2 Double Beds",
        parking : "Free self parking",  
    ...
    {   img :"https://images.trvl-media.com/hotels/10000000/9790000/9784600/9784580/8dd171cc.jpg?impolicy=fcrop&w=1200&h=800&p=1&q=medium",
        roomName :"Room, 1 King Bed, Non Smoking", 
        sqFt:"413 sq ft",
        sleep: "Sleeps 3",
        bed: "1 King Bed",
        parking : "Free self parking",  
    ...
    {   img :"https://images.trvl-media.com/hotels/10000000/9790000/9784600/9784580/8dd171cc.jpg?impolicy=fcrop&w=1200&h=800&p=1&q=medium",
        roomName :"Executive Suite, 1 Bedroom, Non Smoking", 
        sqFt:"818 sq ft",
        sleep: "Sleeps 3",
        bed: "1 King Bed",
        parking : "Free self parking",  
    ...
    {   img :"https://images.trvl-media.com/hotels/10000000/9790000/9784600/9784580/2d4614d2.jpg?impolicy=fcrop&w=1200&h=800&p=1&q=medium",
        roomName :"Premium Suite, 1 King Bed, Non Smoking", 
        sqFt:"936 sq ft",
        sleep: "Sleeps 3",
        bed: "1 King Bed",
        parking : "Free self parking",  
       ...
       {   img :"https://images.trvl-media.com/hotels/10000000/9790000/9784600/9784580/0e2000d7.jpg?impolicy=fcrop&w=1200&h=800&p=1&q=medium",
        roomName :"Deluxe Suite, 1 Bedroom, Non Smoking", 
        sqFt:"818 sq ft",
        sleep: "Sleeps 3",
        bed: "1 King Bed",
        parking : "Free self parking",  
  ...
  localStorage.setItem("roomData",JSON.stringify(checkData));
createRoom(checkData);
var roomDetails =[];

function createRoom(checkData){

checkData.map(function(elem){
